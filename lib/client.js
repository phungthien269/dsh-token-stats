 ...
 * block. English is the primary language: the dashboard opens in English
 * unless the user picks another language in the header picker; the choice
 * persists in localStorage ('dsts-lang-v1').
 */
    ...
    factory: (require) => {
      ...
      function t(key) {
        ...
        if (value === undefined || value === null) {
          value = I18N.en[key] !== undefined ? I18N.en[key] : I18N.vi[key]
        }
